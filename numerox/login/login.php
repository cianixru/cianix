	...
	if(empty($err)){
     ...
     // this sets session and logs user in
	   ...
	   if(isset($_POST['remember'])){
		  ...
		  header("Location: ../base/"); // Location: ../login/myaccount.php
		 }
		}
		else
		{
        ...
        <table width="65%" border="0" cellpadding="4" cellspacing="4" class="loginform">
          ...
          <tr>
            <td colspan="2"><div align="center">
                <input name="remember" type="checkbox" id="remember" value="1">Запомнить меня</div></td>
          </tr>
          <tr>
            <td colspan="2">
            <div align="center"><input name="doLogin" type="submit" id="doLogin3" value="Login"></div>
              </td>
          </tr>
        </table>
